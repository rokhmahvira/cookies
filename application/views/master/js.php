...
<script src="<?php echo base_url() ?>assets/assets/js/jquery.easypiechart.js"></script>
<script src="<?php echo base_url() ?>assets/assets/js/jquery.sparkline.js"></script>
<script src="<?php echo base_url() ?>assets/assets/js/flot/jquery.flot.js"></script>
<script src="<?php echo base_url() ?>assets/assets/js/flot/jquery.flot.pie.js"></script>
<script src="<?php echo base_url() ?>assets/assets/js/flot/jquery.flot.resize.js"></script>
